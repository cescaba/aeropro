...
<body style="margin:0; padding:0; background-color:#f3f4f6; font-family:Poppins, Arial, Helvetica, sans-serif; color:#212121;">
          ...
          <tr>
            <td style="padding:0 32px 40px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:32px 0;">
                <tr>
                  <td align="center">
                    <a href="<?php echo esc_url($verify_url); ?>" style="display:inline-block; padding:14px 28px; background-color:#1447E6; border-radius:<?php echo esc_attr($vc_onboarding_radius); ?>; color:#ffffff; font-size:16px; font-weight:700; line-height:1; text-decoration:none;">
                      Verify email
                    </a>
                  </td>
                </tr>
