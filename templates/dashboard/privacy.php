...
<section class="vc-privacy-shell">
  ...
  <form class="vc-profile-card vc-privacy-card" method="post" action="<?php echo esc_url($action_url); ?>">
    ...
    <label class="vc-profile-field">
      <span class="vc-profile-field-label"><?php esc_html_e('Current password', 'vc-onboarding-wizard'); ?></span>
      <input type="password" name="current_password" autocomplete="current-password" required>
    </label>

    <label class="vc-profile-field">
      <span class="vc-profile-field-label"><?php esc_html_e('New password', 'vc-onboarding-wizard'); ?></span>
      <input type="password" name="new_password" autocomplete="new-password" required>
      <small><?php esc_html_e('Minimum 8 characters', 'vc-onboarding-wizard'); ?></small>
    </label>

    <label class="vc-profile-field">
      <span class="vc-profile-field-label"><?php esc_html_e('Confirm new password', 'vc-onboarding-wizard'); ?></span>
