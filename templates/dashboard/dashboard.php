...
<div class="vc-dashboard-shell">
  <aside class="vc-dashboard-sidebar">
    <div class="vc-dashboard-brand">
      <div class="vc-dashboard-brand-left">
        <!-- Menu hamburguesa: boton mobile que abre/cierra la navegacion y el footer de la sidebar. -->
        <button
          class="vc-dashboard-menu-toggle"
          type="button"
          aria-label="Open dashboard menu"
          aria-expanded="false"
          aria-controls="vc-dashboard-sidebar-menu"
          data-vc-dashboard-menu-toggle
        >
          <span aria-hidden="true"></span>
          <span aria-hidden="true"></span>
          <span aria-hidden="true"></span>
        </button>
        <img class="vc-dashboard-brand-logo" src="<?php echo esc_url($logo_url); ?>" alt="Aeropro">
      </div>

      <!-- Menu hamburguesa: buscador y perfil compactos dentro del brand responsive. -->
      <div class="vc-dashboard-brand-actions" aria-label="Dashboard quick actions">
        <label
          class="vc-dashboard-search vc-dashboard-brand-search"
...
<rect width="16" height="16" fill="white"/>
        ...
        <?php /* Brand user pill link: usa la URL real de My profile desde la navegacion del dashboard. */ ?>
        <a class="vc-dashboard-user-pill vc-dashboard-brand-user-pill" href="<?php echo esc_url($profile_url); ?>" aria-label="<?php esc_attr_e('Go to My profile', 'vc-onboarding-wizard'); ?>">
          <span class="vc-dashboard-avatar">
    ...
    <?php /* Menu hamburguesa: panel unico para que nav y footer compartan ancho, scroll y transicion responsive. */ ?>
    <div class="vc-dashboard-sidebar-menu-panel" id="vc-dashboard-sidebar-menu">
      <nav class="vc-dashboard-nav" aria-label="Dashboard navigation">
        <?php /* Mobile menu header: mirrors the dashboard logo and closes the off-canvas panel. */ ?>
        <div class="vc-dashboard-menu-panel-header">
          <div class="vc-dashboard-menu-panel-header-inner">
            <button class="vc-dashboard-menu-close" type="button" aria-label="Close dashboard menu" data-vc-dashboard-menu-close>
              <svg width="26" height="20" viewBox="0 0 26 20" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M6 3L20 17"
                  stroke="currentColor"
                  stroke-width="2"
        ...
        <div class="vc-dashboard-nav-list">
  ...
  <div class="vc-dashboard-main">
    <header class="vc-dashboard-topbar" id="vc-dashboard-mobile-search">
...
<path d="M9.16667 15.8333C12.8486 15.8333 15.8333 12.8486 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333Z" stroke="#666666" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div class="vc-dashboard-topbar-actions">
        ...
        <?php /* Topbar user pill link: mantiene el mismo destino de perfil que el brand responsive. */ ?>
        <a class="vc-dashboard-user-pill" href="<?php echo esc_url($profile_url); ?>" aria-label="<?php esc_attr_e('Go to My profile', 'vc-onboarding-wizard'); ?>">
    ...
    <?php
    /*
     * Dashboard content modifier: mantiene una estructura unica para todas las vistas.
     * Cada modulo controla su UI interna dentro del panel.
     */
    $show_dashboard_heading = ($active_view !== 'mock-test');
    ?>
    <main class="vc-dashboard-content vc-dashboard-content--<?php echo esc_attr(sanitize_html_class($active_view)); ?>">
      <?php if ($show_dashboard_heading): ?>
      ...
      <section
        class="vc-dashboard-panel vc-dashboard-panel--<?php echo esc_attr($active_view); ?>"
        <?php if ($show_dashboard_heading): ?>
          aria-labelledby="vc-dashboard-panel-title"
        <?php endif; ?>
      >
