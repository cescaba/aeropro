...
<path d="M14.167 27.5H25.8337" stroke="#325CBA" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="vc-subscription-metrics">
      <div>
        <?php // Subscription metric label: agrupa el icono de dinero con el texto Price. ?>
        <div class="vc-subscription-metric-label">
          <svg class="vc-subscription-metric-icon icon-money" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            <path d="M8 1.333V14.667" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M11.333 3.333H6.333C5.714 3.333 5.121 3.579 4.683 4.017C4.246 4.454 4 5.048 4 5.667C4 6.286 4.246 6.879 4.683 7.317C5.121 7.754 5.714 8 6.333 8H9.667C10.286 8 10.879 8.246 11.317 8.683C11.754 9.121 12 9.714 12 10.333C12 10.952 11.754 11.546 11.317 11.983C10.879 12.421 10.286 12.667 9.667 12.667H4" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <small>Price</small>
        </div>
      ...
      <div>
        <?php // Subscription metric label: agrupa el icono de calendario con la fecha de billing. ?>
        <div class="vc-subscription-metric-label">
          <svg class="vc-subscription-metric-icon icon-calendar" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            <path d="M5.333 1.333V4" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.667 1.333V4" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M12.667 2.667H3.333C2.597 2.667 2 3.264 2 4V13.333C2 14.07 2.597 14.667 3.333 14.667H12.667C13.403 14.667 14 14.07 14 13.333V4C14 3.264 13.403 2.667 12.667 2.667Z" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M2 6.667H14" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
      ...
      <div>
        <?php // Subscription metric label: agrupa el icono de reloj con el estado de pago. ?>
        <div class="vc-subscription-metric-label">
          <svg class="vc-subscription-metric-icon icon-clock" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            <path d="M8 4V8L10.667 9.333" fill="none" stroke="currentColor" stroke-width="1.333" stroke-linecap="round" stroke-linejoin="round"/>
            <circle cx="8" cy="8" r="6.667" fill="none" stroke="currentColor" stroke-width="1.333"/>
          </svg>
  ...
  <article class="vc-subscription-card" id="vc-subscription-management">
    <div class="vc-subscription-card-header">
      ...
      <?php // Payment method placeholder: se retiro el badge visual "Gateway pending"; la URL de billing sigue preparada en el shortcode. ?>
    </div>
  ...
  <article class="vc-subscription-card">
    ...
    <?php if (empty($invoice_items)): ?>
      <?php // Latest invoices empty: modificador propio para medir este estado sin afectar Payment Method. ?>
      <div class="vc-subscription-empty vc-subscription-empty--invoices">
  ...
  <article class="vc-subscription-card">
    ...
    <div class="vc-subscription-action-list">
      <a class="vc-subscription-action-item vc-subscription-action-item--modify" href="<?php echo esc_url($levels_url); ?>">
        <div class="vc-subscription-action-copy">
          <strong>Modify plan</strong>
          <span>Switch between monthly and annual plans.</span>
        </div>
        <?php // Subscription action arrow: SVG reutilizable para mantener la flecha alineada a la derecha. ?>
        <svg class="vc-subscription-action-arrow icon-arrow-right" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          <path d="M6 3L11 8L6 13" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </a>
      <a class="vc-subscription-action-item vc-subscription-action-item--cancel" href="<?php echo esc_url($cancel_url); ?>">
        <?php // Subscription cancel main: agrupa icono y texto para alinear ambos a la izquierda. ?>
        <div class="vc-subscription-action-main">
          <?php // Subscription cancel icon: alerta visual de 20x20 controlada desde dashboard.css. ?>
          <svg class="vc-subscription-action-icon icon-alert" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            <circle cx="10" cy="10" r="8.333" fill="none" stroke="currentColor" stroke-width="1.7"/>
            <line x1="10" y1="5.8" x2="10" y2="10.8" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/>
            <circle cx="10" cy="13.6" r="0.9" fill="currentColor"/>
          </svg>
          <div class="vc-subscription-action-copy">
            <strong>Cancel subscription</strong>
            <span>Access remains active until period end.</span>
          </div>
        </div>
        <?php // Subscription action arrow: SVG reutilizable para mantener la flecha alineada a la derecha. ?>
        <svg class="vc-subscription-action-arrow icon-arrow-right" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
